...
function App() {
  ...
  const loadDaiContract = useCallback(
    async (_provider) => {
  ...
  const loadLinkContract = useCallback(
    async (_provider) => {
  ...
  const loadPmknToken = useCallback(
    async (_provider) => {
  ...
  const loadPmknFarmContract = useCallback(
    async (_provider) => {
  ...
  const loadJackContract = useCallback(
    async (_provider) => {
  ...
  const loadLotteryContract = useCallback(
    async (_provider) => {
  ...
  const loadDaiBalance = useCallback(
    async (user) => {
  ...
  const loadPmknBalance = useCallback(
    async (user) => {
  ...
  const loadStakingBalance = useCallback(
    async (user) => {
  ...
  const loadPmknYield = useCallback(
    async (user) => {
  ...
  const loadPmknUnrealizedYield = useCallback(
    async (user) => {
  ...
  const loadWinningNumber = useCallback(
    async (lottoCount) => {
  ...
  const contractStateDidMount = useCallback(async () => {
    ...
    await loadLotteryCount().then(async (res) => {
